    ...
    $('#noRekBS').on('input', function() {
        ...
        if (value.charAt(0) == '0') {
            ...
            if ($(this).next("#checkFormat").length) {
                ...
                $(this).after('<div class="text-white font-weight-bold alert-warning px-2 mt-1" id="checkFormat"> <label> Penulisan Nomor Rekening tidak tidak diawali angka 0  </label> </div>');
